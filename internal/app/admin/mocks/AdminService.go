...
func (_m *AdminService) AdminLogin(ctx context.Context, user dto.AdminLoginRequest) error {
...
func (_m *AdminService) AdminSignup(ctx context.Context, user dto.AdminSignUpRequest) error {
	ret := _m.Called(ctx, user)
...
func (_m *AdminService) GetAdmin(ctx context.Context) ([]dto.AdminResponse, error) {
	ret := _m.Called(ctx)
