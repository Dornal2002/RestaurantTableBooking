...
// AdminBookingService is an autogenerated mock type for the AdminBookingService type
type AdminBookingService struct {
	mock.Mock
}

// AdminAssignTable provides a mock function with given fields: admin
func (_m *AdminBookingService) AdminAssignTable(admin dto.AdminAssignTable) (dto.AdminAssignTable, error) {
	ret := _m.Called(admin)
...
func (_m *AdminBookingService) AdminCancelTable(admin dto.CancelTable) (dto.CancelTable, error) {
	ret := _m.Called(admin)
...
func (_m *AdminBookingService) AdminGetDetails(ctx context.Context) ([]dto.BookingDetails, error) {
	ret := _m.Called(ctx)
...
func (_m *AdminBookingService) AdminUpdateTable(admin dto.UpdateTable, bookingId int64) (dto.UpdateTable, error) {
...
// NewAdminBookingService creates a new instance of AdminBookingService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewAdminBookingService(t interface {
	mock.TestingT
	Cleanup(func())
}) *AdminBookingService {
	mock := &AdminBookingService{}
	mock.Mock.Test(t)
